...
class RangeValidator extends ConstraintValidator
{
    ...
    private function getLimit(?string $propertyPath, mixed $default, Constraint $constraint): mixed
    {
        ...
        try {
            ...
            throw new ConstraintDefinitionException(RangeValidator.phpsprintf('Invalid property path "%s" provided to "%s" constraint: ', $propertyPath, get_debug_type($constraint)), 0, $e);
        }
    }
