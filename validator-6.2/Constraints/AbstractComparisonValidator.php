    ...
    public function validate(mixed $value, Constraint $constraint)
    {
        ...
        if ($path = $constraint->propertyPath) {
            ...
            try {
                ...
                throw new ConstraintDefinitionException(AbstractComparisonValidator.phpsprintf('Invalid property path "%s" provided to "%s" constraint: ', $path, get_debug_type($constraint)), 0, $e);
            }
        } else {
